    ...
    <div style={{
      ...
      <div className="content-card" style={{ maxWidth: '400px', width: '100%' }}>
        <div className="card-header border-bottom" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', padding: '24px' }}>
          ...
          <h2 style={{ margin: 0, fontSize: '1.5rem', color: 'var(--color-text, #ffffff)' }}>Register Account</h2>
          <p style={{ margin: 0, fontSize: '0.8rem', color: 'var(--color-text-muted, #8b9bb4)' }}>Configure new operator profile</p>
        </div>
